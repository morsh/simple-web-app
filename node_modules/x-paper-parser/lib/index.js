...
function run(callback) {
    ...
    callback = callback || Function;
      ...
      function checkQueue() {
          console.log("Querying for next message in queue");
          queueIn.getSingleMessage(function (err, message) {
              ...
              console.log('Start processing message from queue...');
      ...
      function setNextCheck() {
          console.log('Setting next check in %s milliseconds', queueInConfig.checkFrequency);
